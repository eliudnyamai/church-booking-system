...
?>
<!-- Start of session cards template -->
<section class="container-fluid">
    ...
    <div class="row mx-auto  ">
        <?php foreach($sessions as $key => $value): 
           ...
           $slots=count($crud->selectData('booking','*', $condition));
           $remaining=(100-$slots);
        ?>
    <div class="col-md-4 mb-3 ">
            ...
            <div class="modal-body">
              <form method="post" id="booking-form">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="phone" placeholder="07*******" name="phone" required class="form-control" >
                </div>
            </div>
      ...
      <!-- End of modal -->
      <!-- Start of bookings display section -->
